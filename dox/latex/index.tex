...
\end{DoxyItemize}
\item Si se quiere ejecutar con búsqueda local es necesario añadir cada cuantas generaciones, el porcentage de población de 0 al 1 y si es 0=aleatorio 1=Los\+Mejores.
\item Ejecutar un ./run\+AGEST-\/all.sh o el otro tarda alrededor de 4 minutos. 
...
\item Arg13 = A quiénes -\/\texorpdfstring{$>$}{>} 0 es búsque a los seleccionados aleatoriamente y 1 a los mejores.
\end{DoxyItemize}
\end{DoxyItemize}
